...
class WoodCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'master::wood_categories.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\WoodCategory $model
    ...
    {
        return 'wood_categories_datatable_' . time();
    }
}

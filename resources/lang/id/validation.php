...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'email'=>[
            'exists'=>'Email anda tidak tercatat di sistem kami'
        ],
        'token'=>[
            'exists'=>'OTP tidak ditemukan'
        ],'otp'=>[
            'exists'=>'Kode OTP salah'
        ],
        'c_password'=>[
            'required'=>'Konfirmasi password harus di isi',
            'min'=>'Konfirmasi password harus berisi :min karakter',
            'same'=>'Konfirmasi Password dan Password tidak sama'
        ],
        'room_id'=>[
            'exists'=>'room id tidak tersedia'
        ]
